...
Elm.HttpSpy = Elm.HttpSpy || {};
Elm.HttpSpy.make = function (_elm) {
   "use strict";
   _elm.HttpSpy = _elm.HttpSpy || {};
   if (_elm.HttpSpy.values) return _elm.HttpSpy.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   function (v) {
      return v === null ? Elm.Maybe.make(_elm).Nothing : Elm.Maybe.make(_elm).Just(typeof v === "object" && "method" in v && "body" in v ? {_: {}
                                                                                                                                           ...
                                                                                                                                           v.body)} : _U.badPort("an object with fields `method`, `body`",
      v));
   });
   var requestView = function (request) {    return $Html.text($Basics.toString(request));};
   ...
   var Request = F2(function (a,b) {    return {method: a,body: b};});
   var init = {ctor: "_Tuple2",_0: _U.list([A2(Request,"post","hello")]),_1: $Effects.none};
